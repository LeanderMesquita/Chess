...
import com.study.chess.core.chess.pieces.King;
import com.study.chess.core.chess.pieces.Rook;
...
public class ChessMatch {
    ...
    private void validateSourcePosition(Position position){
        ...
        if(!board.piece(position).isThereAnyPossibleMove()) throw new ChessException("There is no possible moves for chosen piece");
    }
